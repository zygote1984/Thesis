...
\graphicspath{{./chapteripc//}{./chapteradapters//}{./chapteroce//}}
...
\lstset{ 
  ...
  tabsize=2,
	...
	emph={aspect, instance, select, UNTIL,pc, instanceType, exp, removeExp, composite, inter, union, .add , .remove, .add_after, .add_before, .remove_after, .remove_before, glue, with, single, retval, parents}, 
	emphstyle=\textbf,
	escapechar={~},
